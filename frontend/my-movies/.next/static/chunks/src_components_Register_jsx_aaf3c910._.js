...
function Register() {
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8080/user/register", {
                username,
                email,
                password,
                address
            ...
            alert(((_err_response1 = err.response) === null || _err_response1 === void 0 ? void 0 : (_err_response_data = _err_response1.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || "Registration failed");
        }
    };
...
_s(Register, "gg9GBdZhHOu+4X/q8nunWIv6LW0=", false, function() {
    return [
...
//# sourceMappingURL=src_components_Register_jsx_aaf3c910._.js.map